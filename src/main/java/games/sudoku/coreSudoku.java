...
public class coreSudoku {
    ...
    public static int level = 1;//normal
    ...
    public static int[][] sudokuArrDef = {{1, 2, 3, 4, 5, 6, 7, 8, 9}, {4, 5, 6, 7, 8, 9, 1, 2, 3}, {7, 8, 9, 1, 2, 3, 4, 5, 6}, {2, 3, 4, 5, 6, 7, 8, 9, 1}, {5, 6, 7, 8, 9, 1, 2, 3, 4}, {8, 9, 1, 2, 3, 4, 5, 6, 7}, {3, 4, 5, 6, 7, 8, 9, 1, 2}, {6, 7, 8, 9, 1, 2, 3, 4, 5}, {9, 1, 2, 3, 4, 5, 6, 7, 8}};
    ...
    public static void startGame() {
        if (gameStart == false) {
            ...
            mixingRandom(1000); //мешает массив 1000 раз, для полного рандома...
            hideNumber(Levels.values()[level].getLvl());
            gameStart = true;
        }
    }
